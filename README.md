    ...
    ## Quick Links
    - Nonprofit: [Dell'Arte International](https://ohack.dev/nonprofit/eObX4Ig63NLCKuKGN8P6)
    - [Hackathon Details](https://www.ohack.dev/hack/2025_summer)
    - [Team Slack Channel](https://opportunity-hack.slack.com/app_redirect?channel=yazmin-opphack-2025)


    ## Creator
    @Yazmin Rodriguez (on Slack)

    ## Team "solo-sprint🏃‍♀️‍➡️"
